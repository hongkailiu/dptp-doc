...
The prowjobs yaml files (`OWNERS` files as well) are generated by `ci-operator-prowgen`. See more [how2](https://github.com/openshift/ci-tools/blob/master/CI_OPERATOR_PROWGEN.md#tldr).
