...
curl -o "${TMP_DIR}/openshift-client-mac-${VERSION}.tar.gz" "https://openshift-release-artifacts.apps.ci.l2s4.p1.openshiftapps.com/${VERSION}/openshift-client-mac-arm64-${VERSION}.tar.gz"
